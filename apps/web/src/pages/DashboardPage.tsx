    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Tổng quan hệ thống, tiến độ run mới nhất, và leaderboard của run done gần nhất.</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-7">
        ...
        <StatCard label="Avg confidence" value={avgConfidence} suffix="/100" />
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 bg-white border rounded-2xl p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-xs text-gray-500">{latestRun ? latestRun.status : "No runs yet"}</div>
          </div>
            ...
            <div className="mt-3 space-y-2 text-sm">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                <button
                  ...
                  title={latestRun.status !== "done" ? "Run chưa done" : "Xem Results"}
                >
                  View results
                </button>
        ...
        <div className="bg-white border rounded-2xl overflow-hidden">
          <div className="p-4 border-b">
            ...
            <div className="text-xs text-gray-500 mt-1">
              Theo run done gần nhất: <span className="font-mono">{latestDoneRun?._id ?? "N/A"}</span>
            </div>
          </div>

          {!latestDoneRun ? (
            <div className="p-4 text-sm text-gray-600">Chưa có run done để tạo leaderboard.</div>
          ) : (
